...
if [ $1 = "up" ]; then
  ...
  MARIADB_POD=`kubectl -n ${NAMESPACE} get pods | grep -i mariadb | awk '{print $1}'`

  echo "Forwarding ports..."
  kubectl -n k8s-cl1 port-forward --address 0.0.0.0 ${COUCHDB_POD} 50201:5984 50203:5984 &
  echo $! >> kubectl.pid
  kubectl -n k8s-cl1 port-forward --address 0.0.0.0 ${MONGODB_POD} 50101:27017 50103:27017 &
  echo $! >> kubectl.pid
  kubectl -n k8s-cl1 port-forward --address 0.0.0.0 ${MARIADB_POD} 50301:3306 &
  echo $! >> kubectl.pid
  ...
  docker-compose -f ../lab/phpmyadmin/docker-compose.yaml up -d
elif [ $1 = "down" ]; then
  ...
  docker-compose -f ../lab/phpmyadmin/docker-compose.yaml down
